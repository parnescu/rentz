		...
		render: function(){
			if (this.model && this.collection){
				...
				this.collection.each(function(item, i){
					_type = item.get('gameType').get('name').toUpperCase();
					_enabled = item.get('available');
					this.list.append("<li><a class='avatar' href='#selectRound' data-active='"+_enabled+"' data-round="+i+" class='"+_type+"'title='"+item.get('gameType').get('type')+"'>"+_type+"</a></li>");
				},this);
				_type = _enabled = null;
			}
			return this;
