	...
	describe('Project views', function(){
		...
		describe('List view', function(){
			...
			it('adding a collection generates list based on model type', function(){
				var c = Backbone.Collection.extend({ model: Player });
				collection = new c()
